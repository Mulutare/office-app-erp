...
<section class="card finance-filter-panel">
    ...
    <form method="post" action="/office_app/public/sales/orders" class="finance-filter-form">
        ...
        <div class="filter-actions"><button class="btn btn-primary" type="submit" name="confirm" value="1">Confirm order</button><button class="btn btn-secondary" type="submit">Save draft</button></div>
    </form>
</section>
<?php endif; ?>
...
<section class="card table-card">
    ...
    <div class="table-responsive"><table class="data-table"><thead><tr><th>Order</th><th>Customer</th><th>Date / due</th><th>Total</th><th>Paid</th><th>Balance</th><th>Status</th><?php if (!empty($data['canRecordPayments'])): ?><th>Receipt</th><?php endif; ?></tr></thead><tbody>

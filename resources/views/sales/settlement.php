...
<div class="module-stack settlement-workspace">
    ...
    <section class="card erp-record-header">
        <div><a class="erp-back-link" href="<?= e(appBasePath() . '/sales/settlements') ?>">&larr; Settlement history</a><p class="erp-eyebrow">Sales settlement</p><h2><?= e($settlement['settlement_number']) ?></h2><p>Settlement evidence, bank reconciliation and approval history</p></div>

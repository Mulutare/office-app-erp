...
<?php if ($isSuspended): ?>
    <div class="alert alert-warning" role="status">
        <strong>This company is suspended.</strong>
        Profile and commercial settings can be prepared here,
        but customer access remains blocked until the vendor
        explicitly reactivates it from the company details page.
    </div>
<?php endif; ?>
    ...
    <div class="company-provisioning-layout">
        <div class="company-provisioning-main">
            <section class="card company-form-section">
                <div class="company-form-heading">
                    ...
                    <div>
                        ...
                        <p>
                            Maintain the customer-facing and
            ...
            <section class="card company-form-section">
                <div class="company-form-heading">
                    ...
                    <div>
                        ...
                        <p>
                            Configure the tenant defaults used
                            throughout its ERP workspace.
                        </p>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-field form-field-wide">
                        ...
                        <div class="company-color-field">
                            ...
                            >
                            <span>
                                Used by the customer workspace
                                and future branded documents.
                            </span>
                        </div>
                        <?php if (!empty($errors[
                            'brand_primary_color'
            ...
            <section class="card company-form-section">
                <div class="company-form-heading">
                    <span>03</span>
                    <div>
                        <h2>Licensed ERP modules</h2>
                        <p>
                            Enable only the utilities purchased
                            by this customer.
                        </p>
                    </div>
                </div>
        ...
        <aside class="company-provisioning-sidebar">
            <section class="card company-subscription-card">
                ...
                <h2>Subscription</h2>
                <p class="form-help">
                    Suspension is controlled separately so an
                    ordinary edit cannot unexpectedly remove
                    customer access.
                </p>
                ...
                <div class="company-provisioning-note">
                    <strong>Vendor-governed licensing</strong>
                    <p>
                        Profile and module changes are applied
                        atomically and recorded in the audit
                        log.
                    </p>
                </div>
            </section>

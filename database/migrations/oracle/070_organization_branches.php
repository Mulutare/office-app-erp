...
return [
    'version' => '070',
    'description' =>
        'Create tenant-scoped organization branches',
    'statements' => [
        <<<'SQL'
...
SQL,
        'CREATE INDEX ix_org_branches_company_active'
            . ' ON organization_branches ('
            . 'company_id, active, deleted_at'
            . ')',
        'CREATE INDEX ix_org_branches_company_head'
            . ' ON organization_branches ('
            . 'company_id, is_head_office, '
            . 'active, deleted_at'
            . ')',
        <<<'SQL'
...
USING (
    SELECT
        'View Company Branches' AS name,
        'organization.branches.view' AS code,
